...
final coursesListProvider = FutureProvider.autoDispose<List<Course>>((
  ref,
) async {
  ...
  return repo.listCourses(search: search, department: dept, level: level);
});
...
final myCourseEnrollmentProvider = FutureProvider.autoDispose
